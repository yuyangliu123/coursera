...
const OrderOnline2 = () => {
  ...
  console.log("search",isSearching,"searchResults.length = 0",searchResults.length == 0,"searchResults",searchResults,"menu.data",menu.data);
//here should set default menu.data
  ...
  //set scroller height
  const stackMinHeight = isSearching && searchResults.length > 0
