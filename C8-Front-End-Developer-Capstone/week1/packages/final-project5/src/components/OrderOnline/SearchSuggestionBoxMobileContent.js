...
const SearchSuggestionBoxMobileContent = () => {
    ...
    return (
        <Box
                    ...
                    zIndex="1000"
                >
        <Box position="relative" borderRadius={itemInfo.borderRadius} ref={searchBoxRef}>
...
export default SearchSuggestionBoxMobileContent;
