import { Box, Button, HStack, Heading, Image, Spinner, Stack, Text, VStack, Skeleton, SkeletonText, useToast, getToastPlacement, Flex, Grid, GridItem } from "@chakra-ui/react"; import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
    ...
    <Stack width={{ lg: "70%", base: "100%" }}>
      ...
      >
        {Array.from({ length: 12 }).map((_, index) => (
          <GridItem border={itemInfo.itemBorder} marginBottom="30px" 
          marginRight="5px">
            <Skeleton key={index} height={itemInfo.itemHeight} />
          </GridItem>
        ))}
      </Grid>
    </Stack>
