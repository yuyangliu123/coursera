...
const OrderOnline2 = () => {
  ...
  const handleSearch = async (event) => {
    ...
    try {
      const response = await axios.post('http://localhost:5000/api/search', { searchString });
  ...
  const debouncedHandleSearch = debounceRAF(handleSearch, 1000);
          ...
          <Stack width={{ lg: "70%", base: "100%" }}>
            <HStack id="filterContainer" justifyContent="space-between">
              ...
              <InputGroup width="30%">
                ...
                <Input id="searchBox" placeholder="Search" onChange={debouncedHandleSearch} />
              </InputGroup>
              <Box ref={sortResultsRef}>
                <HStack
                  width="20vh"
