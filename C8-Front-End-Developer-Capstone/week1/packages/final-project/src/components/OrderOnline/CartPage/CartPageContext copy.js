...
export const CartPageContextProvider = ({ children, initialData }) => {
    ...
    return (
        <CartPageContext.Provider value={{ addPendingItems, finishPending, userInfo, setUserInfo, cartData, setCartData }}>
            {children}
